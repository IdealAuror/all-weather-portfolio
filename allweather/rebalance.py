...
用法：
    python -m allweather.rebalance                          # 交互引导
    python -m allweather.rebalance --strat V3c              # 指定策略
    python -m allweather.rebalance --strat V3c --amount 50万 # 直接建仓
    python -m allweather.rebalance --signals                # 只看信号
