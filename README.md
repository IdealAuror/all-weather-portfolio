...
| **V3-B (60d)** | 学院派 | 7.27% | -6.29% | 1.14 | 认同桥水方法论，战术灵活 |
| **V3-B 保守增强(60d)** | 保守派 | 5.92% | -3.52% | 1.80 | 睡得着觉，回撤最低 |

> 三条路线对应三种价值观：V3c 看回测，V3-B 看方法论，保守增强看夏普和回撤。
>
> 回测期：2015-01 ~ 2025-12（~11 年）
> 调仓规则：V3c 半年节点 + 3% 偏离阈值；V3-B 月度调仓
