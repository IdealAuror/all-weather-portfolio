...
|---|---|---|---|---|---|
| **V3c 多元** | 简约派 | 9.37% | -6.96% | 1.49 | 6资产逆波动率 60d + HS300抄底 — 零负收益年份 |
| **V3-B 风险平价(20d)** | 学院派 | **11.40%** | -9.48% | 1.30 | 4桶等权 RP + 三趋势过滤 + Gold/HS300抄底 — 回报最高 |
| **V3-B 保守增强(20d)** | 保守增强 | 7.90% | **-6.40%** | **1.68** | 逆波动率 + HS300抄底 — 零负收益年份 |

> V3-B RP 含 nonferr trend filter (75d) + gold trend filter (75d) + sp500 trend filter (120d) + Gold/HS300 抄底，月度调仓。
> V3c 和 B-Con 含 nonferr trend filter（60d / 75d）+ HS300 抄底（PE 30%ile/exit 70%ile + DD 25%/exit peak-15%）。
...
**V3-B 风险平价(20d) (学院派)**
- 长期回报最高 CAGR 11.40%，累计 923%；四桶真正等权(25%×4)，三层趋势过滤+Gold/HS300抄底
- 回撤(-9.48%)，最差年份 2011 -5.01%；桶逻辑比另外两个策略复杂
- 适合：长期持有者(5年+)、认同正统全天候理念、能承受短期波动

**V3-B 保守增强(20d) (保守增强)**
- 回撤最低(-6.40%)，Sharpe 最高(1.68)，熊市表现最好（2008 +14.95%）
- 牛市可能跑输(2019仅+9.61%，2017仅+4.17%)；长期累计回报最低(414%)
...
| HS300 抄底 PE | entry 30%ile / exit 70%ile / boost 1.8x | PE 估值低+价格>SMA90 时加仓 |
| HS300 抄底 DD | entry 25% / exit peak-15% / boost 1.8x | 价格回撤深+价格>SMA120 时加仓 |
