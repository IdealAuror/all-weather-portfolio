...
| 方案 | 推荐度 | CAGR | 回撤 | Sharpe | 特征 |
|---|---|---|---|---|---|
| V3-A 保守 | ★★ | 6.83% | -8.16% | 1.14 | 含 20% 短债，阈值再平衡 |
| **V3-B (60d)** | ★★★ | 7.01% | -5.98% | 1.14 | 分层风险平价，月度逆波动率调仓 |
| V3-B (120d) | ★★★ | 6.84% | -6.37% | 1.09 | 长窗口风险平价，战略定位 |

> 注：V3-A/V3-B 已砍掉原版中从不触发的回撤止损/相关断路器，以及帮倒忙的趋势过滤/波动率降仓。详见他[诊断结论](#)。

回测期：2015-01 ~ 2025-12（~11 年）
调仓规则：半年节点（6/12 月底）+ 3% 偏离阈值双触发（固定权重）；月度（V3-B）
