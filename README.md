...
|---|---|---|---|---|---|
| **V3c 多元** | 实战派 | 7.76% | -4.68% | 1.44 | 固定权重月度调仓+趋势过滤，简单落地 |
| **V3-B (20d)** | 学院派 | 9.62% | -4.14% | 1.80 | CAGR 最高，5桶RP+趋势过滤+Gold/HS300抄底 |
| **V3-B 保守增强(20d)** | 保守派 | 7.90% | -3.57% | 2.04 | 睡得着觉，回撤最低，Sharpe最优 |

> V3-B 5桶+Gold/HS300抄底 CAGR 领跑（9.62%）；V3c 月度调仓+趋势过滤（7.76%）；保守增强+Gold/HS300抄底 Sharpe 最高（2.04）。
>
> 回测期：2015-01 ~ 2025-12（~11 年）
> 调仓规则：全策略月度调仓 + nonferr 趋势过滤 + Gold 抄底
