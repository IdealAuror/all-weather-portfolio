...
|------|:----:|:----:|:------:|:--------:|:-----:|--------|
| **V3-B 保守增强(20d)** | 保守增强 | 8.25% | 3.93% | **-5.30%** | **1.54** | 逆波动率 20d + nonferr(75d) + HS300 AND 抄底 |
| **V3-B 风险平价(20d)** | 学院派 | 9.28% | 5.21% | -6.52% | 1.36 | 4 桶等权 HRP + nonferr/gold/sp500/hs300 趋势 + 抄底 + 波动率控制 |
| **V3c 多元** | 多元全天候 | **9.44%** | 5.09% | -6.74% | **1.42** | 7 资产逆波动率 60d + nonferr/sp500 趋势(75d) + HS300 AND 抄底 |

> V3-B RP 四重趋势过滤：nonferr(75d) + gold(75d) + sp500(75d) + hs300(30d)；V3c 双趋势过滤：nonferr(75d) + sp500(75d)。不含 bond_10y（CAGR +1.43pp, Sharpe -0.02）。V3c 多元 7 资产逆波动率 60d，同样不含 bond_10y。原油暴露用南方原油 LOF(501018) 实现（目前申购暂停）。
