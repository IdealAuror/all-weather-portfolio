...
|------|:----:|:----:|:--------:|:-----:|--------|
| **V3c 多元** | 简约派 | 7.95% | -7.01% | **1.59** | 6 资产逆波动率 60d + nonferr 趋势 + HS300 AND 抄底 |
| **V3-B 风险平价(20d)** | 学院派 | **10.20%** | -9.48% | 1.40 | 4 桶等权 RP + nonferr/gold/sp500 趋势 + Gold/HS300 抄底 |
| **V3-B 保守增强(20d)** | 保守增强 | 6.72% | **-6.40%** | **1.67** | 逆波动率 20d + nonferr 趋势 + HS300 AND 抄底 |
...
**V3-B 保守增强(20d) (保守增强)** — 逆波动率加权（20d 回看，max_w=0.25）+ nonferr 趋势过滤 + HS300 AND 抄底。含 bond_10y（7 资产）。Sharpe 最高(1.67)，熊市表现最好，年化成本拖累仅 0.19%。适合保守资金、退休金、无法忍受大幅回撤。
