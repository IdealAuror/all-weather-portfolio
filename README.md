...
| **V3-B (20d)** | 学院派 | 8.13% | -4.14% | 1.69 | CAGR 最高，5桶RP+趋势过滤 |
| **V3-B 保守增强(20d)** | 保守派 | 6.86% | -3.57% | 1.98 | 睡得着觉，回撤最低，Sharpe最优 |

> V3-B 5桶(10Y/30Y分拆) CAGR 领跑（8.13%）；V3c 月度调仓+趋势过滤（7.76%）；保守增强 Sharpe 最高（1.98）。
>
> 回测期：2015-01 ~ 2025-12（~11 年）
> 调仓规则：全策略月度调仓 + nonferr 趋势过滤
