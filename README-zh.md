...
|------|:----:|:----:|:------:|:--------:|:-----:|--------|
| **V3-B 保守增强(20d)** | 保守增强 | **8.35%** | 3.66% | **-5.28%** | **1.82** | 逆波动率 20d + nonferr(75d) + HS300 AND 抄底 |
| **V3-B 风险平价(20d)** | 学院派 | 9.39% | 4.95% | -6.63% | 1.55 | 4 桶等权 HRP + nonferr/gold/sp500/hs300 趋势 + 抄底 + 波动率控制 |
| **V3c 多元** | 多元全天候 | **10.16%** | 5.17% | -6.30% | 1.63 | 6 资产逆波动率 20d + nonferr/gold/sp500 趋势(75d) + HS300 AND 抄底 |
...
- **不可执行风险**：回测假设每月**月末最后交易日**收盘价成交（避开商品期货月中换月窗口，`REBAL_MODE=month_end`），实盘存在滑点和流动性差异
