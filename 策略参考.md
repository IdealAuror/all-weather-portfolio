...
| V4 全天候杠杆 | `backtest.py::backtest_iv` → 统一`backtest()` | 逆波动率 60d + **bond_10y T.CFFEX 动态杠杆(正常3x/债市破位1.5x)** + nonferr 75d + HS300 AND抄底 | 9 | CAGR 9.15%, Sharpe 1.57, MDD -7.40%, Calmar 1.24 |
