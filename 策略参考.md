...
| V4 全天候杠杆 | `backtest.py::backtest_iv` → 统一`backtest()` | 逆波动率 60d + **bond_10y T.CFFEX 3x杠杆** + nonferr 75d + HS300 AND抄底 | 9 | CAGR 9.20%, Sharpe 1.53, MDD -9.91%, 接近国泰海通全天候 |
...
| `LEVERAGE_FACTORS["bond_10y"]` | 3.0 | V4 T.CFFEX 10Y 国债期货杠杆倍数（原 5x→3x 控制回撤） |
