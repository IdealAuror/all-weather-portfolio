...
|---|---|---|---|---|---|
| V3c 多元 | **7.45%** | 4.16% | -6.71% | **1.79** | 1.11 |
| V3b 平衡 | 7.12% | 4.03% | -6.99% | 1.77 | 1.02 |
| V3d 商品偏重 | 7.24% | 4.63% | -8.59% | 1.57 | 0.84 |

数据来源：`output/summary.json`，由 `python main.py` 自动生成。
注：Sharpe = CAGR / Vol（未减无风险利率）。11 年覆盖了 2015 股灾、2016 熔断、2018 大熊市等极端情景，指标较 5.5 年期更保守但更真实。
