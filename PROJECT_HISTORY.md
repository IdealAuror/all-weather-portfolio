...
**8. 多资产趋势过滤无额外增益（两次验证）。** 对 soymeal / gold / 权益分别加趋势过滤均不改善指标。对全部 9 资产加趋势过滤反而降低 CAGR 0.61%（6.86→6.25%）。nonferr 是唯一值得过滤的资产——它是回撤的头号元凶。
...
**14. 方案 C（70/30 动态现金/信用债补仓）完全失败。** 无论储备金形态（现金 2.2% 或信用债），30% 储备的拖累效应远超逢低补仓的收益。纯 100% risk_parity 碾压所有参数组合。**核心教训：储备金的机会成本 > 择时收益。**
