...
| 策略 | 一句话 |
|------|--------|
| V3-B 保守增强(20d) | 逆波动率20d + nonferr75d趋势 + HS300 AND抄底 — Sharpe {BCON_SHARPE} |
| V3c 多元 | 6资产逆波动率60d + nonferr/gold/sp500趋势75d + HS300 AND抄底 — MDD {V3C_MDD} |
| V3-B 风险平价(20d) | 4桶HRP + 四重趋势 + 抄底 + target_vol=9% — CAGR {BRP_CAGR} |
