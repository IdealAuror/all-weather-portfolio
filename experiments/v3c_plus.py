...
from allweather.config import STRESS_EVENTS, V3C_ASSETS, V3B_RP_BUCKETS_NO_WTI, V3B_RP_ASSETS_NO_WTI
...
configs = [
    ...
    ("V3-B RP 基准", lambda: backtest_b(rets[V3B_RP_ASSETS_NO_WTI], cash_ratio=0.0, rp_window=20,
